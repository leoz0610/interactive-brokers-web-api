...
from simulation.strategies import BuyAndHoldStrategy, MovingAverageCrossoverStrategy
...
def run_buy_and_hold_example():
    ...
    # Save results
    output_file = 'simulation/data/buy_and_hold_results.json'
...
def run_moving_average_example():
    ...
    # Save results
    output_file = 'simulation/data/moving_average_results.json'
    save_results_to_json(results, output_file)
    print(f"Results saved to {output_file}")
...
def compare_strategies():
    ...
    for results in results_list:
        ...
        print(f"{strategy_name:<40} {total_return:>+6.2f}%        {sharpe:>6.2f}    {max_dd:>6.2f}%")
