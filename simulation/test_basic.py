...
print("\n5. Testing Strategy...")
try:
    from simulation.strategies import BuyAndHoldStrategy
...
try:
    ...
    print(f"   ✓ Final portfolio value: ${results['portfolio_summary']['total_value']:,.2f}")
...
print("Run 'python3 simulation/example_backtest.py' for full examples.")
print()
